...
namespace UnitTestsProject
{
    ...
    public class PowerConsumptionExperiment
    {
        ...
        {
            const int inputBits = 400; /* without datetime component */ // 13420; /* with 4096 scalar bits */ // 10404 /* with 1024 bits */;
            ...
            sw.Start();
            for (int i = 0; i < 5; i++) Train(inputBits, layer1, cls, true); // New born mode.
            sw.Stop();
        ...
        private float Train(int inpBits, IHtmModule<object, object> network, HtmClassifier<double, ComputeCycle> cls, bool isNewBornMode = true)
        {
            ...
            string fileName = "TestFiles\\sinusoidal.csv";
        ...
        private static Dictionary<string, object> getScalarEncoderDefaultSettings(int inputBits)
        {
            ...
            encoderSettings.Add("W", 21/*21*/);                       //the number of bits that are set to encode a single value -the "width" of the output signal 
