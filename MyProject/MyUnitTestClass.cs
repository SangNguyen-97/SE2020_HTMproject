...
namespace MyUnitTest
{
    ...
    public class MyUnitTestClass
    {
        ...
        public void MyTestMethod()
        {
            ...
            string E_outFolder_train = $"{E_outFolder}\\train"; // Encoder's graphical output (PNG format) during "Training mode" will be created here
            ...
            string[] input_list_robustness = { "N-0-0p1", "N-0-0p2", "N-0-0p3", "N-0-0p4", "N-0-0p5", "N-0-0p6", "N-0-0p7", "N-0-0p8", "N-0-0p9", "N-0-1", "N-0-1p5", "N-0-2", "N-0-2p5", "N-0-3", "N-0-3p5", "N-0-4" };

            foreach (string input in input_list_robustness)
            {

                E_inFile_robustness = $"{E_inFolder}\\Noisy_{input}_sinusoidal.csv";
                SP_outFile_robustness = $"{SP_outFolder_compare}\\compare_{input}.csv";
                Encoding(E_inFile_robustness, SP_inFile_robustness, E_outFolder, E_outBits);
