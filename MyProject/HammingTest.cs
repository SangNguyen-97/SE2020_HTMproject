...
//            string SP_inFolder = "MyEncoderOutput";
//            string SP_noisyinFolder = "MyNoisyEncoderOutput";
//            Directory.CreateDirectory(SP_inFolder);
//            Directory.CreateDirectory(SP_noisyinFolder);
//            string SP_inFile = $"{SP_inFolder}\\MyEncoderOut.csv";
//            string SP_noisyinFile = $"{SP_noisyinFolder}\\MyNoisyEncoderOut.csv";
...
//            string SP_outFile = $"{SP_outFolder}\\MySPOut.csv";
//            string SP_noisyoutFile = $"{SP_noisyoutFolder}\\MyNoisySPOut.csv";
...
//                    NeoCortexUtils.DrawBitmap(SP_twoDimArray, 1024, 1024, $"{SP_outFolder}\\{lineNumber}.png", Color.DimGray, Color.LawnGreen, text: tokens[0]);
//                    lineNumber++;
//                }
//            }
...
//                    var SP_twoDimArray = ArrayUtils.Transpose(SP_twoDimenArray);
//                    NeoCortexUtils.DrawBitmap(SP_twoDimArray, 1024, 1024, $"{SP_noisyoutFolder}\\{lineNumber}.png", Color.DimGray, Color.LawnGreen, text: tokens[0]);
//                    lineNumber++;
//                }
//            }
...
//        {
//            string E_inFile = "MyEncoderInput\\sequence.csv";
//            string E_outFolder = "MyEncoderOutput";
//            string E_noisyinFile = "MyEncoderInput\\noisy_sequence.csv";
